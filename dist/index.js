 ...
 *
 * Hand-written on purpose: this machine has no node/npm, and the built output of a
 * Decky plugin is a single ESM file that takes React and @decky/ui from globals.
 * If a toolchain ever lands here, rewrite as TSX + @decky/rollup; see README.
 *
...
// ---- @decky/api handshake (this is what the real bundler inlines) --------------
const API_VERSION = 2;
const internalAPIConnection =
  window.__DECKY_SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_deckyLoaderAPIInit;
if (!internalAPIConnection) {
  throw new Error("[ally-fp] Decky loader API was not initialized");
}
let api;
try {
